...
X = df['cleaned_tweet'].astype(str)  # Convert tweets to string format

# Convert Tweets into Numerical Representation (TF-IDF)
tfidf = TfidfVectorizer(max_features=5000, stop_words='english')
X_tfidf = tfidf.fit_transform(X)

# Apply K-Means Clustering (2 clusters for Liberal & Conservative)
num_clusters = 2
...
# After inspecting top words, decide which cluster represents which political leaning
cluster_mapping = {0: "Liberal", 1: "Conservative"}  # Change based on word analysis
...
# Example Usage
new_tweet = "Tax cuts are great for economic growth."
